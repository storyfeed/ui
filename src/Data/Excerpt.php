...
class Excerpt implements FeedDetail
{
    ...
    /**
     * `Storyfeed/Excerpt` — the VOCABULARY'S name, not this package's.
     *
     * A detail outlives whichever library defined it ({@see FeedDetail}), so
     * the name must not contain the library: `storyfeed-ui/excerpt` would repeat
     * the `storyfeed-filament/excerpt` fork one package over. The name is a pure
