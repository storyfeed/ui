...
class Change implements FeedDetail
{
    ...
    /**
     * `Storyfeed/Change` — the VOCABULARY'S name, not this package's.
     *
     * A detail outlives whichever library defined it ({@see FeedDetail}), so
     * the name must not contain the library: `storyfeed-ui/change` would repeat
     * the `storyfeed-filament/change` fork one package over. The name is a pure
